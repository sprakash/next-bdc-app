        ...
        <div className="w-1/2">
          ...
          {film.year && (
              <p className="font-semibold mt-8">
                Year: <span className="bg-yellow-100 text-gray-800 px-2 py-1 hover:bg-blue-950 hover:text-blue-200 hover:cursor-pointer">{film.year}</span>
              </p>
          )}

          {film.summary && (
            <p className="my-4">{film.summary}</p>
          )}
