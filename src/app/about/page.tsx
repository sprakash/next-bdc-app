export default function AboutPage() {
    ...
    <main className="min-h-[200px] mt-24">
        <div className="md:flex-none lg:flex items-center pt-4 px-8 bg-linear-to-r from-gray-800 to-black min-h-[250px] pb-20">
            <div className="flex-1  border-b border-gray-600  md:w-full lg:w-4/5">
                <h1 className="text-5xl font-bold text-gray-200 mb-4 mt-20">
                About Us
                </h1>
                <p className="text-gray-300  pb-8 text-2xl pt-10 md:w-full lg:w-4/5">
